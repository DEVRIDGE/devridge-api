...
class RoadmapRepositoryTest {
    ...
    public void getRoadmapsIncludingCoursesByCompanyInfo_with_not_user_test() {
        ...
        assertThat(roadmapStatusDtoList.get(0).getCourse().getId()).isEqualTo(1L);
        ...
        assertThat(roadmapStatusDtoList.get(1).getCourse().getId()).isEqualTo(3L);
        ...
        assertThat(roadmapStatusDtoList.get(2).getCourse().getId()).isEqualTo(4L);
        ...
        assertThat(roadmapStatusDtoList.get(3).getCourse().getId()).isEqualTo(2L);
